...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_PIN0) |      \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOA_ZIO_D20))
...
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_ZIO_D33) |       \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_A6) |         \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D27) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D23) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D25) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D22) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D26) |        \
                                     PIN_MODE_OUTPUT(GPIOB_LED2) |          \
                                     PIN_MODE_OUTPUT(GPIOB_ARD_D15) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ARD_D14) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D36) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D35) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D19) |        \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D18) |        \
                                     PIN_MODE_OUTPUT(GPIOB_LED3) |          \
                                     PIN_MODE_OUTPUT(GPIOB_ZIO_D17))
...
#define VAL_GPIOB_ODR               (PIN_ODR_LOW(GPIOB_ZIO_D33) |           \
                                     ...
                                     PIN_ODR_LOW(GPIOB_ZIO_D23) |          \
                                     PIN_ODR_LOW(GPIOB_ZIO_D25) |          \
                                     PIN_ODR_LOW(GPIOB_ZIO_D22) |          \
                                     PIN_ODR_LOW(GPIOB_ZIO_D26) |          \
                                     PIN_ODR_LOW(GPIOB_LED2) |              \
                                     PIN_ODR_LOW(GPIOB_ARD_D15) |          \
                                     PIN_ODR_LOW(GPIOB_ARD_D14) |          \
                                     PIN_ODR_LOW(GPIOB_ZIO_D36) |          \
                                     PIN_ODR_LOW(GPIOB_ZIO_D35) |          \
                                     PIN_ODR_LOW(GPIOB_ZIO_D19) |          \
                                     PIN_ODR_LOW(GPIOB_ZIO_D18) |          \
                                     PIN_ODR_LOW(GPIOB_LED3) |              \
                                     PIN_ODR_LOW(GPIOB_ZIO_D17))
...
#define VAL_GPIOC_MODER             (PIN_MODE_INPUT(GPIOC_ARD_A1) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOC_ZIO_D45) |        \
                                     PIN_MODE_INPUT(GPIOC_ZIO_D46) |        \
                                     PIN_MODE_OUTPUT(GPIOC_ZIO_D47) |        \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_ARD_A1) |       \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOC_ZIO_D47) |      \
